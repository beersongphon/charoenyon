...
<body>
  ...
  <div class="row p-4">
    ...
    <div class="col-9">
      <center>
        <h2>เพิ่มรายการเคาะพ่นสี</h2>
        <form method="POST" action="" style="width:50%; text-align: left;">
          <div class="form-group">
            <label>รายละเอียด</label>
            <textarea class="form-control" name="pt_detail" rows="3"></textarea>
          </div>
          <div class="form-group">
            <label>ส่วน</label>
            <input class="form-control" name="pt_part" type="text" placeholder="กรอกส่วน" required>
          </div>
          <div class="form-group">
            <label>ราคา</label>
            <input class="form-control" name="paint_price" type="number" placeholder="กรอกราคา" required>
          </div>
    ...
    if ($_POST) {
      ...
      $sql = "INSERT INTO car_painting (pt_detail, pt_part, paint_price) VALUES ('" . $pt_detail . "', '" . $pt_part . "', " . $paint_price . ")";
      $result = $conn->query($sql);
      if ($result == TRUE) {
        echo "<script>
