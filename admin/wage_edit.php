          ...
          <center>
            ...
            <form method="POST" action="" style="width:50%; text-align: left;">
              <div class="form-group">
                ...
                <textarea name="wage_detail" class="form-control" rows="3" required><?php echo $row["wage_detail"]; ?></textarea>
              </div>
              <div class="form-group">
                <label>ค่าแรง</label>
                <input class="form-control" name="wage_price" type="number" placeholder="กรอกค่าแรง" required value="<?php echo $row["wage_price"]; ?>">
              </div>
